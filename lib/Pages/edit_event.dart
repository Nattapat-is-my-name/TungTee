                          ...
                          if (!dateEnd1.isBefore(dateStart1)) {
                            if (_editEventFormKey.currentState!.validate()) {
                              ...
                              EventProvider().updateEventEndDate(
                                  widget.eventId, DateTime.parse(dateEnd.text));
                              EventProvider().updateEventEndDate(widget.eventId,
                              ...
                              EventProvider()
                                  .updateEventTag(widget.eventId, selectedTag);
                              EventProvider()
                                  .updateEventTitle(widget.eventId, title.text);
