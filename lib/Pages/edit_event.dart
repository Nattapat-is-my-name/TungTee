    ...
    return FutureBuilder(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.done) {
            ...
            dateStart.text = event!.dateOfEvent.start.toString();
            dateEnd.text = event.dateOfEvent.end.toString();
            detail.text = event.eventDescription;
            location.text = event.location;
            ageM.text = event.ageRestriction.maximumAge.toString();
            ageN.text = event.ageRestriction.minimumAge.toString();
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              FilledButton(
                                onPressed: () async {
                                  if (_editEventFormKey.currentState!
                                      .validate()) {
